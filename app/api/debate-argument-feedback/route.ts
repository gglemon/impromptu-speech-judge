...
import { debateArgumentFeedbackPrompt } from "@/lib/prompts/debate";
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const prompt = debateArgumentFeedbackPrompt({ resolution, side, argument, round, previousArguments, difficulty });
