...
import { sparRebuttalPrompt } from "@/lib/prompts/spar";
...
export async function POST(req: NextRequest) {
  try {
    ...
    const prompt = sparRebuttalPrompt({ resolution, aiSide, aiConstructive, userConstructive, userCrossfire, difficulty, aiDifficulty });
