...
import * as handler from "@/app/api/spar-user-rebuttal-hint/route";
...
describe("POST /api/spar-user-rebuttal-hint", () => {
  it("returns hint on success", async () => {
    vi.mocked(callLLM).mockResolvedValueOnce(llmJson({ hint: "Counter the evidence." }));
